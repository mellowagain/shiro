...
void TaskScheduler::TaskQueue::RemoveIf(std::function<bool(const TaskContainer&)> const& filter)
{
...
void TaskScheduler::TaskQueue::ModifyIf(std::function<bool(const TaskContainer&)> const& filter)
{
